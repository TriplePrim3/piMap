const UI = (() => {
  ...
  const FEATURE_PROMPTS = [
    ...
    { achId: 'multi_part', html: '<div class="bubble-title">Go big or go home</div>Try a full phrase — if π can\'t fit it in one piece, I\'ll track down every fragment. I\'m relentless like that.' },
